...
function PortfolioGallery() {
    ...
    return(
        <div className="flex flex-col m-auto mb-6 gap-5">
            ...
            {modal && 
                <div onClick={toggleModal} className="modal-backdrop fixed top-0 left-0 right-0 w-full h-full bg-gray-400/55">
                    <div onClick={e => e.stopPropagation()} className="modal-content fixed top-10 left-10 right-10 bg-red-500">
                        <PortfolioModal 
